...
export class WhatsAppController {
    ...
    constructor(){
        ...
        this.initAuth();
        this._title = 'WhatAapp Clone';
        this.elementsPrototype();
        //carregue os elementos
        this.loadElements();
        this.initEvents();
        ...
        this._firebase.initAuth()
            .then(response => {
                ...
                this._user.on('datachange', data => {
                    ...
                    document.querySelector('title').innerHTML = data.name + ' - ' + this._title;
    ...
    loadElements(){
        ...
        //obj que recebe as propriedades
        this.el = {};

        document.querySelectorAll('[id]').forEach(element => {

            //colocar dentro de um Camel Case
    ...
    initEvents(){
                ...
                if (data.name) {
                    ...
                    Chat.createIfNotExists(this._user.email, contact.email).then(chat => {
                        ...
                        this._user.addContact(contact).then(() => {
                            ...
                            console.info('Usuário foi adicionado!');
        ...
        this.el.btnAttachDocument.on('click', e => {
            ...
            // abrir arq do sistema operacional
            ...
            if (this.el.inputDocument.files.length) {
                ...
                this._documentPreviewController.getPreviewData().then(result => {
                    ...
                    switch (file.type) {
                        ...
                        case 'application/vnd.openxmlformats-officedocument.presentatioml.presentatio':
        ...
        this.el.btnSend.on('click').on('click', e => {
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            emoji.on('click', e => {                
                ...
                //verificar se o cursor esta focado no input da msg
                ...
                //levar cursor par o final da msg
                ...
                // forçar o event keyup para retirar o placeholder
    ...
    closeMenuAttach(e) {
        ...
        //console.log('remove menu attach');
    }
